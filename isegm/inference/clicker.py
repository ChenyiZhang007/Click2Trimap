...
class Clicker(object):
    ...
    def add_click(self, click):
        ...
        click.indx = self.click_indx_offset + self.num_pos_clicks + self.num_neg_clicks + self.num_uk_clicks

        if click.flag == 0:
            self.num_pos_clicks += 1
        if click.flag == 1:
            self.num_uk_clicks += 1
        if click.flag == 2:
...
class Click:
    def __init__(self, flag, coords, indx=None):
        self.flag = flag
        self.coords = coords
        self.indx = indx
